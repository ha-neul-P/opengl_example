...
bool Context::Init() {
    ...
    m_sphericalMapProgram = Program::Create("./shader/spherical_map.vs", 
        "./shader/spherical_map.fs");
...
void Context::DrawScene(const glm::mat4& view, const glm::mat4& projection,
